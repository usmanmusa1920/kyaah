...
# Insert Kyaah' path into the system.
...
def grep(attrname):
    ...
    file_path = os.path.join(ORIGIN, 'kyaah/__init__.py')
...
latex_documents = [
    (master_doc, 'Kyaah.tex', 'Kyaah Documentation',
     'Usman Musa', 'manual'),
]
...
man_pages = [
    (master_doc, 'kyaah', 'Kyaah Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Kyaah', 'Kyaah Documentation',
     author, 'Kyaah', 'One line description of project.',
     'Miscellaneous'),
]
